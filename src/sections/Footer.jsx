  ...
  return (
    <footer className="max-container">
      <div className="flex justify-around items-start gap-20 flex-wrap max-lg:flex-col">
        ...
        <div className="flex flex-1 justify-around max-lg:justify-start lg:gap-10 gap-20 flex-wrap">
      ...
      <div className="flex justify-between text-white-400 mt-4 max-sm:flex-col max-sm:items-center">
        ...
        <div className="flex items-center gap-5 mt-8">
          {socialMedia.map((icon) => (
            <div
              className="flex justify-center items-center w-12 h-12 bg-white rounded-full hover:bg-sky-300"
              key={icon.alt}
            >
